...
def detectAndTrackMultipleFaces():
    ...
    try:
        while True:
            ...
            baseImage = cv2.resize(fullSizeBaseImage, (1180, 860))
            ...
            if (frameCounter % 10) == 0:
                ...
                for (_x, _y, _w, _h) in faces:
                    ...
                    w = int(_w)
                    h = int(_h)
                    face_crop = baseImage[y:y + h, x:x + w]
                    ...
                    if matchedFid is None:
                        ...
                        time.sleep(0.5)
                        #if (face_crop)
                        cv2.imshow('face_' + str(face_index), face_crop)
                        cv2.imwrite('D:/MiAI_FaceRecog_2/video/faces.jpg', face_crop)
                        #cv2.imwrite('D:/faster_facial_landmarks/faster_facial_landmarks/faces.jpg', face_crop)
