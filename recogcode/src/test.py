...
def main():
    ...
    with tf.Graph().as_default():
        ...
        #while (cap.isOpened()):
            ...
            bounding_boxes, _ = detect_face.detect_face(cap, MINSIZE, pnet, rnet, onet, THRESHOLD, FACTOR)
            ...
            try:
                ...
                if faces_found > 0:
                    ...
                    for i in range(faces_found):
                        ...
                        cv2.rectangle(cap, (bb[i][0], bb[i][1]), (bb[i][2], bb[i][3]), (0, 255, 0), 2)
                        text_x = bb[i][0]
                        text_y = bb[i][3] + 20
                        ...
                        cv2.putText(cap, name, (text_x, text_y), cv2.FONT_HERSHEY_COMPLEX_SMALL,
                                    1, (255, 255, 255), thickness=1, lineType=2)
                        cv2.putText(cap, str(round(best_class_probabilities[0], 3)), (text_x, text_y + 17),
